...
export const liveWorks: Work[] = [
  {
    ...
    built:
      "牛舎で、スマホを開いたその場で確認・記録できる繁殖管理アプリです。記録を入れると、次に手を打つべき牛の順に自動で並び替わり、待機中の牛が先頭に来ます。開いた瞬間に「今日どれを見るか」が決まります。分娩・妊娠鑑定・発情の予定日が近づくと、7日前と3日前にメールでお知らせするので、アプリを開き忘れても見逃しません。過去の記録も後から修正できます。アプリのインストールは不要です。",
    result:
    ...
    flow: [
      ...
      {
        title: "予定日の前にメールが届く",
        body: "分娩予定日・妊娠鑑定日・次の発情予定日の7日前と3日前に、メールでお知らせします。授精から21日後の発情注意は、3日前と当日に届きます。忙しくてアプリを開けない日でも、見逃しを防げます。",
      },
    ],

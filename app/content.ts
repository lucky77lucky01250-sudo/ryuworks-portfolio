...
export const liveWorks: Work[] = [
  {
    ...
    built:
      "牛舎で、スマホを開いたその場で確認・記録できる繁殖管理アプリです。記録を入れると、次に手を打つべき牛の順に自動で並び替わり、待機中の牛が先頭に来ます。開いた瞬間に「今日どれを見るか」が決まります。分娩・妊娠鑑定・発情の予定日が近づくと、7日前と3日前にメールでお知らせします（次の発情予定日は当日の朝にも届きます）。アプリを開き忘れても見逃しません。過去の記録も後から修正できます。アプリのインストールは不要です。",
    result:
      "宮崎県内の繁殖農家2戸に導入しました。発情の見逃しと分娩事故を減らすことが目的で、パソコン管理からの時間短縮も伴いますが、本当の効果は経営面にあります。発情を1回見逃せば分娩は3週間遅れ、それがそのまま1頭あたりの年間収益に響くためです。",
    flow: [
      {
        title: "牛舎でスマホを開く",
        body: "アプリのインストールは不要です。ホーム画面から開くと、すぐ牛の一覧が出ます。",
      },
      {
        title: "日付をひとつ入れる",
        body: "発情・種付け・妊娠鑑定・分娩のうち、その日にあったことを1つ記録します。入力はこれだけです。",
      },
      {
        title: "次の予定日が自動で出る",
        body: "授精日から285日後が分娩予定、40日後が妊娠鑑定、不受胎なら21日後に発情。この計算を人がしなくて済みます。",
      },
      {
        title: "手を打つべき牛が先頭に来る",
        body: "一覧は繁殖の段階順に並び替わり、予定日を過ぎた牛は赤で警告が出ます。開いた瞬間に「今日どれを見るか」が決まります。",
      },
      {
        title: "予定日の前にメールが届く",
        body: "分娩予定日・妊娠鑑定日・次の発情予定日の7日前と3日前に、メールでお知らせします。発情はその日に見ないと分からないので、次の発情予定日は当日の朝にも届きます。授精から21日後の発情注意は、3日前と当日に届きます。忙しくてアプリを開けない日でも、見逃しを防げます。",
      },
    ],
  ...
  },
  {
    ...
    flow: [
      {
        title: "LINEに送る",
        body: "文章を1行送るか、案内やイベント画面のスクリーンショットをそのまま送ります。新しいアプリを覚える必要はありません。",
      },
      {
        title: "AIが読み取る",
        body: "日時・場所・内容を読み取ります。1枚に複数の予定が写っていれば、まとめて取り出します。",
      },
      {
        title: "カレンダーに入る",
        body: "Googleカレンダーに登録し、予定の種類ごとに色分けまで自動でつけます。場所も地図の欄に入ります。",
      },
      {
        title: "毎朝、予定が届く",
        body: "その日の予定と今週の予定が、毎朝7時にLINEへ自動で届きます。入れ忘れや見落としが減ります。",
      },
    ],
...
export const caseWorks: Work[] = [
  ...
  },
  {
    ...
    before: "総務に都度聞きに行く",
    after: "Slackでその場で回答",
    summary: "いつものSlackで質問すると、社内規程を読んだAIが答えます。",
    problem:
    ...
    flow: [
      {
        title: "資料を読み込ませる",
        body: "マニュアル・規程・報告書などを取り込み、検索できる形に変換します。",
      },
      {
        title: "いつものSlackで質問する",
        body: "専用の画面を開く必要はありません。普段使っているチャットの中で聞けます。",
      },
      {
        title: "関係する箇所を探す",
        body: "言葉が一致していなくても、意味の近い部分を資料の中から探し出します。",
      },
      {
        title: "出典つきで答える",
        body: "「どの資料の何ページか」を併記して答えます。部署ごとに見える資料を分けられるので、権限の外の資料は答えに出ません。",
      },
    ],
  ...
  },
  {
    ...
    before: "月末の集計 2〜3時間",
    after: "ゼロ",
    summary: "販路ごとのデータを1画面にまとめ、いつ見ても最新の数字が出ます。",
    problem:
  ...
  },
  {
    ...
    flow: [
      {
        title: "キーワードを1行入れる",
        body: "スプレッドシートにキーワードと関連語を入れます。入力はこれだけです。",
      },
      {
        title: "メニューから実行する",
        body: "「記事生成」を押すと、未生成の行だけを対象に動きます。二重に生成しない作りです。",
      },
      {
        title: "下書きができあがる",
        body: "タイトル・メタディスクリプション・本文が、同じ行に書き込まれます。構成は決まった型（導入 → 見出し3つ → まとめ）にそろいます。",
      },
      {
        title: "人は確認して仕上げる",
        body: "60〜70点の下書きを人が直す前提です。WordPressへ下書きとして送る仕組みも組み込んであります（実際のサイトへの接続はまだ行っていません。自動公開はしない設計です）。",
      },
    ],
...
export const why = {
  ...
  values: [
    {
      title: "使う人が迷わない",
      body: "説明書を読まないと使えないものは、現場では使われません。",
    },
    {
      title: "小さく作って、現場で試す",
      body: "全部そろえてから出すより、動くものを早く現場に置いて直します。",
    },
    {
      title: "続けられることを優先",
      body: "機能を増やすより、毎日の手順に収まることを先に考えます。",
    },
  ],
  /** 章の挿絵（Geminiで生成。文字は入れない。全案の元画像はSSD「プロフィール画像/サイト挿絵_2026-09-16」） */
  likesImage: {
    src: "/illust-likes.jpg",
    alt: "山あいの道の脇に、ダンベルとリュックが置いてある絵",
  },
  futureImage: {
    src: "/illust-future.jpg",
    alt: "牛舎から伸びる道が、育っていく芽の間を通って町のお店や会社につながっている絵",
  },
  /** 好きなこと。本人が載せてよいと決めたものだけ（家族のことは載せない） */
  likes: [
    {
      title: "筋トレ",
      body: "週に数回、ダンベルと懸垂、エアロバイクを続けています。気合いより、続けやすい形を先に作るようにしています。",
    },
    {
      title: "いろいろな地域を訪ねること",
      body: "仕事をしながら、国内のいろいろな地域に行ってみたいと思っています。",
    },
  ],
  future: [
    "畜産で作ってきた仕組みを広げて、農業など第一次産業の現場で役立つものを、もっと多くの方に届けたいと考えています。",
    "あわせて、宮崎を拠点に、地域を問わず、お店や会社で毎日くり返されている作業を減らしていきたいです。",
...
export const steps = {
  ...
  items: [
    {
      title: "話を聞く",
      body: "まだ形になっていない段階で構いません。「これは自動化できるのか」を聞くだけでも大丈夫です。",
    },
    {
      title: "小さく作って試す",
      body: "いきなり全部を作らず、いちばん手間のかかっている作業から形にします。",
    },
    {
      title: "使い始めに付き添う",
      body: "最初の入力や設定を、一緒に行います。宮崎県内なら伺って隣で、県外ならオンラインで画面を見ながら進めます。",
    },
    {
      title: "使いながら直す",
      body: "使っている方から要望をもらい、直しながら続けます。",
    },
  ],
};
...
export const tools = {
  ...
  items: [
    {
      title: "LINE",
      body: "送るだけで予定や記録が入る。問い合わせの自動応答も",
    },
    {
      title: "Googleカレンダー・スプレッドシート",
      body: "予定の登録、集計、転記の自動化",
    },
    { title: "Slack", body: "いつものチャットの中で、社内の資料に質問できる" },
    { title: "Webサイト", body: "問い合わせの一次対応を24時間" },
    {
      title: "会計ソフト",
      body: "領収書の読み取りから、取り込める形のデータまで",
    },

...
export const caseWorks: Work[] = [
  ...
  },
  {
    ...
    built:
      "スプレッドシートにキーワードを入力してメニューを実行すると、AIがタイトル・メタディスクリプション・本文の下書きを作り、同じ行に書き込みます。人は確認して仕上げるだけです。WordPressへ下書きとして投稿することもできます（自動公開はしません）。",
    result:
    ...
    flow: [
      ...
      { title: "人は確認して仕上げる", body: "60〜70点の下書きを人が直す前提です。WordPressへ下書きとして投稿することもできます（自動公開はしません）。" },
    ],
...
export const steps = {
  ...
  note: "作って終わりにせず、使い続けられるところまで一緒に進めます。",
  items: [
